...
fileName = 'DATOScRUDOSpARAeNTRENARlArED.xlsx'
...
for i, i_vel_enfr in enumerate(vel_enfr):
    ...
    # borramos la primer fila MultiIndex: 'Stalk' y 'Marc'-.
...
calc_deriv_obj = calc_Deriv(df_stalk_list[0], df_marc_list, 'Temp', 'DrTGA', 1.0, 'Marc')
calc_deriv_obj.original_data_sns_regplot(os.getcwd())
