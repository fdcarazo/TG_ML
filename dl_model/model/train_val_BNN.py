...
# -*- coding: utf-8 -*-
#
# SCRIPT: 2train and validate any BNN-FFNN-.
##
# @AUTHOR: Fernando Diego Carazo (@buenaluna) -.
# start date (Fr): Mon Mar  4 12:39:33 CET 2024-.
# last modify (Fr): -.
# last modify (Arg): vie 09 ago 2024 09:51:28 -03-.
##
# ====================================================================== INI79
...
class TrainPredict(BayesianNet):
    def __init__(self, model, train_dl, val_dl, inp, out, loss, optimizer,
                 kl_loss, device, w_d, lr, kl_weight
                 ):
        ''' class constructor
        Args:
        =====
        ...
        '''
        super(TrainPredict, self).__init__(inp, out, loss, optimizer, kl_loss,
                                           device, w_d, lr, kl_weight)  # oldVers-.
        '''
        super().__init__(inp, out, loss, optimizer, kl_loss, device, w_d, lr,
                         kl_weight)   # NewVers-.
