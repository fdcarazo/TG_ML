...
## ======================================================================= END79
# - =======================================================================INI79                                             
## 1-1- Auxiliaries classes and functions-.                                                                                  
## 2 convert seconds in hour:minutes;seconds                                                                                 
def convert_to_preferred_format(sec):
    ...
    sec%= 60 # minutes-.
    ## print('seconds value in hours: {0}'.format(hour))
    ## print('seconds value in minutes: {0}'.format(min))
